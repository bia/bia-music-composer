...
METADATA="install-gpu-driver=True,MODEL_SIZE=${MODEL_SIZE},RUN_MODE=${RUN_MODE},PROJECT_ID=${PROJECT_ID},DOCKER_REGION=${DOCKER_REGION},GCS_BUCKET_FOLDER_PREFIX=${GCS_BUCKET_FOLDER_PREFIX},GCS_BUCKET_NAME=${GCS_BUCKET_NAME},GCS_PAIRS_PATH=${GCS_PAIRS_PATH},GCS_TAGS_PATH=${GCS_TAGS_PATH},NUM_PREFIX_TOKENS=${NUM_PREFIX_TOKENS:-32},WAVLM_MODEL=${WAVLM_MODEL:-microsoft/wavlm-base},TRAINING_SCRIPT=direct,NUM_STEPS=${NUM_STEPS},BACKBONE_ALIGN=${BACKBONE_ALIGN},BACKBONE_ALIGN_STEPS=${BACKBONE_ALIGN_STEPS}"
